...
estimationModuleConfig <- createModuleConfig(
  moduleId = "estimation_cm",
  tabName = "Estimation_cm",
  shinyModulePackage = "OhdsiShinyModules",
  shinyModulePackageVersion = "3.3.0",
  moduleUiFunction = "cohortMethodKaplanMeierViewer",
  moduleServerFunction = "cohortMethodKaplanMeierServer",
  moduleIcon = "info"
)
